...
def prepare_segmentation_message(activity_id, user_id, segments_df, processed_at, start_date):
...
def send_segmentation_output(activity_id, user_id, segments_df, processed_at, start_date):
    """Send segmentation output message to Kafka."""
    # Prepare message with compressed segments
    kafka_message = prepare_segmentation_message(activity_id, user_id, segments_df, processed_at, start_date)
